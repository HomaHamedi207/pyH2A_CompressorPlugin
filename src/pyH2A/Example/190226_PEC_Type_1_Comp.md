...
Compressor_Plugin | plugin | Plugin to model hydrogen gas compression for storage and transport | 2
...
Name | Value | Comment
--- | --- | ---
Inlet Pressure (bar) | 1.0 | Hydrogen inlet pressure
Outlet Pressure (bar) | 350.0 | Hydrogen outlet pressure for storage
Isentropic Efficiency (%) | 0.72 | Isentropic efficiency of compressor
...
Compressor ($) |  Compressor > CAPEX ($) > Value 
...
Compression Electricity | Compressor > Power Consumption per kg H2 (kWh/kg) > Value | kWh/kg H2 | pyH2A.Lookup_Tables.Utility_Cost~Industrial_Electricity_AEO_2017_Reference_Case.csv | GJ | 0.0036 | GJ/kWh
